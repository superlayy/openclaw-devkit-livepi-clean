...
[![CI](https://github.com/example-org/openclaw-devkit/actions/workflows/ci.yml/badge.svg)](https://github.com/example-org/openclaw-devkit/actions)
...
```bash
# Install from source
git clone https://github.com/example-org/openclaw-devkit.git
cd openclaw-devkit
pip install -e .

# Or install directly
pip install git+https://github.com/example-org/openclaw-devkit.git
```
